 ...
 * @generated
 */
public class EcimGeneralTypeClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "EcimGeneralType"); //$NON-NLS-1$
    }
}
