 ...
 * @generated
 */
public class EcimServerAssociationEndClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "EcimServerAssociationEnd"); //$NON-NLS-1$
    }
}
