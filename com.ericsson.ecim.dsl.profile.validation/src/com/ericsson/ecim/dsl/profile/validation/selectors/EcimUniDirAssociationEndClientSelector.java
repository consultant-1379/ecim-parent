 ...
 * @generated
 */
public class EcimUniDirAssociationEndClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "EcimUniDirAssociationEnd"); //$NON-NLS-1$
    }
}
