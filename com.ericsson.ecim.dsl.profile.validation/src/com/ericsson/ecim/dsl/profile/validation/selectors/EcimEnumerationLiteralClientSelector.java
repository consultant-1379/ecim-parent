 ...
 * @generated
 */
public class EcimEnumerationLiteralClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "EcimEnumerationLiteral"); //$NON-NLS-1$
    }
}
