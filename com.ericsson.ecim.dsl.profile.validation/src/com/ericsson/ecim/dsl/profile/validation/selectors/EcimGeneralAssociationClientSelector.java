 ...
 * @generated
 */
public class EcimGeneralAssociationClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "EcimGeneralAssociation"); //$NON-NLS-1$
    }
}
