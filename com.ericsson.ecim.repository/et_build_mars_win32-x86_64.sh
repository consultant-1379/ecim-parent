...
wget http://eclipse.mirror.garr.it/mirrors/eclipse/technology/epp/downloads/release/mars/1/eclipse-java-mars-1-win32-x86_64.zip

unzip eclipse-java-mars-1-win32-x86_64.zip
rm -f eclipse-*.zip
...
java -jar eclipse/plugins/org.eclipse.equinox.launcher_1.3.100.v20150511-1540.jar -application org.eclipse.equinox.p2.director -noSplash -repository ${ECIM_TOOLCHAIN_REPOSITORY},${PAPYRUS_UPDATE_SITE},${ECLIPSE_UPDATE_SITE},${LUNA_UPDATE_SITE},${COMMON_DEPENDENCY_UPDATE_SITE} -installIU com.ericsson.ecim.feature.feature.group,com.ericsson.ecim.coremw.feature.feature.group,com.ericsson.ecim.mmas.feature.feature.group,com.ericsson.ecim.cpp.feature.feature.group,com.ericsson.ecim.vdicos.feature.feature.group,com.ericsson.ecim.yang.feature.feature.group,com.ericsson.ecim.mgc.feature.feature.group,com.ericsson.ecim.stn.feature.feature.group
...
zip -q -r ecim_toolchain_${ET_VERSION}_mars_win32-x86_64.zip eclipse/
rm -rf eclipse/
