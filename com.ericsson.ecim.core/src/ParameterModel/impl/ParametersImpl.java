 ...
 * <ul>
 *   <li>{@link ParameterModel.impl.ParametersImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametersImpl extends EObjectImpl implements Parameters {
    ...
    protected EClass eStaticClass() {
        return ParameterModelPackage.Literals.PARAMETERS;
    }
    ...
    public EList<Parameter> getParameter() {
        if (parameter == null) {
            parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, ParameterModelPackage.PARAMETERS__PARAMETER);
        }
        return parameter;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case ParameterModelPackage.PARAMETERS__PARAMETER:
