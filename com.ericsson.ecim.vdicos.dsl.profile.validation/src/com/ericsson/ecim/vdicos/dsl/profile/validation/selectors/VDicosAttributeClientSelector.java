...
package com.ericsson.ecim.vdicos.dsl.profile.validation.selectors;
 ...
 * @generated
 */
public class VDicosAttributeClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "VDicosAttribute"); //$NON-NLS-1$
    }
}
