...
package com.ericsson.ecim.coremw.dsl.profile.validation.selectors;
 ...
 * @generated
 */
public class CmwStructMemberClientSelector implements IClientSelector {

    public boolean selects(Object stereoApplicationObj) {
        return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "CmwStructMember"); //$NON-NLS-1$
    }
}
