...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Int8 Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link Mp.Int8Type#getRange <em>Range</em>}</li>
 *   <li>{@link Mp.Int8Type#getRanges <em>Ranges</em>}</li>
 *   <li>{@link Mp.Int8Type#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link Mp.Int8Type#getUnit <em>Unit</em>}</li>
 *   <li>{@link Mp.Int8Type#getMultiplicationFactor <em>Multiplication Factor</em>}</li>
 *   <li>{@link Mp.Int8Type#getResolution <em>Resolution</em>}</li>
 *   <li>{@link Mp.Int8Type#getUndefinedValue <em>Undefined Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see Mp.MpPackage#getInt8Type()
 * @model extendedMetaData="name='int8_._type' kind='elementOnly'"
 * @generated
 */
public interface Int8Type extends DataType {
    /**
	 ...
	 * @see Mp.MpPackage#getInt8Type_Range()
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_Ranges()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getRanges <em>Ranges</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_DefaultValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getDefaultValue <em>Default Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_Unit()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getUnit <em>Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_MultiplicationFactor()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getMultiplicationFactor <em>Multiplication Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_Resolution()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getResolution <em>Resolution</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getInt8Type_UndefinedValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Int8Type#getUndefinedValue <em>Undefined Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
