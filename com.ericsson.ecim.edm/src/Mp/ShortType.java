 ...
 * <ul>
 *   <li>{@link Mp.ShortType#getRange <em>Range</em>}</li>
 *   <li>{@link Mp.ShortType#getRanges <em>Ranges</em>}</li>
 *   <li>{@link Mp.ShortType#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link Mp.ShortType#getUnit <em>Unit</em>}</li>
 *   <li>{@link Mp.ShortType#getMultiplicationFactor <em>Multiplication Factor</em>}</li>
 *   <li>{@link Mp.ShortType#getResolution <em>Resolution</em>}</li>
 *   <li>{@link Mp.ShortType#getUndefinedValue <em>Undefined Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see Mp.MpPackage#getShortType()
 * @model extendedMetaData="name='short_._type' kind='elementOnly'"
 * @generated
 */
public interface ShortType extends DataType {
    /**
	 ...
	 * @see Mp.MpPackage#getShortType_Range()
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_Ranges()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getRanges <em>Ranges</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_DefaultValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getDefaultValue <em>Default Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_Unit()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getUnit <em>Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_MultiplicationFactor()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getMultiplicationFactor <em>Multiplication Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_Resolution()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getResolution <em>Resolution</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getShortType_UndefinedValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.ShortType#getUndefinedValue <em>Undefined Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
