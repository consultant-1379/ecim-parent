...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Uint8 Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link Mp.Uint8Type#getRange <em>Range</em>}</li>
 *   <li>{@link Mp.Uint8Type#getRanges <em>Ranges</em>}</li>
 *   <li>{@link Mp.Uint8Type#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link Mp.Uint8Type#getUnit <em>Unit</em>}</li>
 *   <li>{@link Mp.Uint8Type#getMultiplicationFactor <em>Multiplication Factor</em>}</li>
 *   <li>{@link Mp.Uint8Type#getResolution <em>Resolution</em>}</li>
 *   <li>{@link Mp.Uint8Type#getUndefinedValue <em>Undefined Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see Mp.MpPackage#getUint8Type()
 * @model extendedMetaData="name='uint8_._type' kind='elementOnly'"
 * @generated
 */
public interface Uint8Type extends DataType {
    /**
	 ...
	 * @see Mp.MpPackage#getUint8Type_Range()
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_Ranges()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getRanges <em>Ranges</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_DefaultValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getDefaultValue <em>Default Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_Unit()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getUnit <em>Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_MultiplicationFactor()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getMultiplicationFactor <em>Multiplication Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_Resolution()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getResolution <em>Resolution</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getUint8Type_UndefinedValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.Uint8Type#getUndefinedValue <em>Undefined Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
