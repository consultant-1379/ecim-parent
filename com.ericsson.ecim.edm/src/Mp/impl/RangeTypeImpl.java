 ...
 * <em><b>Range Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Mp.impl.RangeTypeImpl#getMax1 <em>Max1</em>}</li>
 *   <li>{@link Mp.impl.RangeTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link Mp.impl.RangeTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link Mp.impl.RangeTypeImpl#getMin1 <em>Min1</em>}</li>
 *   <li>{@link Mp.impl.RangeTypeImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RangeTypeImpl extends EObjectImpl implements RangeType {
    ...
    protected EClass eStaticClass() {
		return MpPackage.eINSTANCE.getRangeType();
	}
    ...
    public NotificationChain basicSetMax(MaxType newMax, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MpPackage.RANGE_TYPE__MAX, oldMax, newMax);
    ...
    public void setMax(MaxType newMax) {
		if (newMax != max) {
			...
			if (max != null)
				msgs = ((InternalEObject)max).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MpPackage.RANGE_TYPE__MAX, null, msgs);
			if (newMax != null)
				msgs = ((InternalEObject)newMax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MpPackage.RANGE_TYPE__MAX, null, msgs);
			msgs = basicSetMax(newMax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MpPackage.RANGE_TYPE__MAX, newMax, newMax));
	}
    ...
    public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, MpPackage.RANGE_TYPE__GROUP);
		}
		return group;
	}
    ...
    public EList<MinType> getMin() {
		if (min == null) {
			min = new EObjectContainmentEList<MinType>(MinType.class, this, MpPackage.RANGE_TYPE__MIN);
		}
		return min;
	}
    ...
    public EList<MaxType> getMax1() {
		if (max1 == null) {
			max1 = new EObjectContainmentEList<MaxType>(MaxType.class, this, MpPackage.RANGE_TYPE__MAX1);
		}
		return max1;
	}
	 ...
	 * @generated
	 */
    public NotificationChain basicSetMin1(MinType newMin1,
            NotificationChain msgs) {
		MinType oldMin1 = min1;
		min1 = newMin1;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MpPackage.RANGE_TYPE__MIN1, oldMin1, newMin1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setMin1(MinType newMin1) {
		if (newMin1 != min1) {
			NotificationChain msgs = null;
			if (min1 != null)
				msgs = ((InternalEObject)min1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MpPackage.RANGE_TYPE__MIN1, null, msgs);
			if (newMin1 != null)
				msgs = ((InternalEObject)newMin1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MpPackage.RANGE_TYPE__MIN1, null, msgs);
			msgs = basicSetMin1(newMin1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MpPackage.RANGE_TYPE__MIN1, newMin1, newMin1));
	}
    ...
    public void addRanges(String ranges) {
        if (ranges == null || ranges.length() < 4)//check is no range was specified or if the range was to short to make sense
            return;
        ...
        for (String minMax : minMaxPairs) {
            ...
            getGroup().add(MpPackage.eINSTANCE.getRangeType_Min(), min);
            ...
            if(!(maxString.equals("*") && minMaxPairs.length==1))
            {
                ...
                getGroup().add(MpPackage.eINSTANCE.getRangeType_Max1(), max);
            }
        }
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			case MpPackage.RANGE_TYPE__MAX1:
				return ((InternalEList<?>)getMax1()).basicRemove(otherEnd, msgs);
			case MpPackage.RANGE_TYPE__MIN:
				return ((InternalEList<?>)getMin()).basicRemove(otherEnd, msgs);
			case MpPackage.RANGE_TYPE__MAX:
				return basicSetMax(null, msgs);
			case MpPackage.RANGE_TYPE__MIN1:
				return basicSetMin1(null, msgs);
			case MpPackage.RANGE_TYPE__GROUP:
