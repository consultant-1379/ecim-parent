 ...
 * <ul>
 *   <li>{@link Mp.impl.SpecificationTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecificationTypeImpl extends EObjectImpl implements SpecificationType {
    ...
    protected EClass eStaticClass() {
		return MpPackage.eINSTANCE.getSpecificationType();
	}
    ...
    public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, MpPackage.SPECIFICATION_TYPE__MIXED);
		}
		return mixed;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MpPackage.SPECIFICATION_TYPE__MIXED:
