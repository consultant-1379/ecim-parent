 ...
 * <ul>
 *   <li>{@link Mp.impl.DependenciesTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesTypeImpl extends EObjectImpl implements DependenciesType {
    ...
    protected EClass eStaticClass() {
		return MpPackage.eINSTANCE.getDependenciesType();
	}
    ...
    public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, MpPackage.DEPENDENCIES_TYPE__MIXED);
		}
		return mixed;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MpPackage.DEPENDENCIES_TYPE__MIXED:
