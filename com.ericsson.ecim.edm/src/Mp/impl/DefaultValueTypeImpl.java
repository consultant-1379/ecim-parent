 ...
 * <ul>
 *   <li>{@link Mp.impl.DefaultValueTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DefaultValueTypeImpl extends EObjectImpl implements DefaultValueType {
    ...
    protected EClass eStaticClass() {
		return MpPackage.eINSTANCE.getDefaultValueType();
	}
    ...
    public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, MpPackage.DEFAULT_VALUE_TYPE__MIXED);
		}
		return mixed;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MpPackage.DEFAULT_VALUE_TYPE__MIXED:
