 ...
 * <ul>
 *   <li>{@link Mp.DoubleType#getRange <em>Range</em>}</li>
 *   <li>{@link Mp.DoubleType#getRanges <em>Ranges</em>}</li>
 *   <li>{@link Mp.DoubleType#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link Mp.DoubleType#getUnit <em>Unit</em>}</li>
 *   <li>{@link Mp.DoubleType#getMultiplicationFactor <em>Multiplication Factor</em>}</li>
 *   <li>{@link Mp.DoubleType#getResolution <em>Resolution</em>}</li>
 *   <li>{@link Mp.DoubleType#getUndefinedValue <em>Undefined Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see Mp.MpPackage#getDoubleType()
 * @model extendedMetaData="name='double_._type' kind='elementOnly'"
 * @generated
 */
public interface DoubleType extends DataType {
	 ...
	 * @see Mp.MpPackage#getDoubleType_Range()
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_Ranges()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getRanges <em>Ranges</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_DefaultValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getDefaultValue <em>Default Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_Unit()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getUnit <em>Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_MultiplicationFactor()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getMultiplicationFactor <em>Multiplication Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_Resolution()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getResolution <em>Resolution</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getDoubleType_UndefinedValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.DoubleType#getUndefinedValue <em>Undefined Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
