 ...
 * <ul>
 *   <li>{@link Mp.IntegerType#getRange <em>Range</em>}</li>
 *   <li>{@link Mp.IntegerType#getRanges <em>Ranges</em>}</li>
 *   <li>{@link Mp.IntegerType#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link Mp.IntegerType#getUnit <em>Unit</em>}</li>
 *   <li>{@link Mp.IntegerType#getMultiplicationFactor <em>Multiplication Factor</em>}</li>
 *   <li>{@link Mp.IntegerType#getResolution <em>Resolution</em>}</li>
 *   <li>{@link Mp.IntegerType#getUndefinedValue <em>Undefined Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see Mp.MpPackage#getIntegerType()
 * @model extendedMetaData="name='integer_._type' kind='elementOnly'"
 * @generated
 */
public interface IntegerType extends DataType {
	 ...
	 * @see Mp.MpPackage#getIntegerType_Range()
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_Ranges()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getRanges <em>Ranges</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_DefaultValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getDefaultValue <em>Default Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_Unit()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getUnit <em>Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_MultiplicationFactor()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getMultiplicationFactor <em>Multiplication Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_Resolution()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getResolution <em>Resolution</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see Mp.MpPackage#getIntegerType_UndefinedValue()
	 * @model containment="true"
    ...
    /**
	 * Sets the value of the '{@link Mp.IntegerType#getUndefinedValue <em>Undefined Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
