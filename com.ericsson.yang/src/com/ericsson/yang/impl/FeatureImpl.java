 ...
 * <ul>
 *   <li>{@link com.ericsson.yang.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.ericsson.yang.impl.FeatureImpl#getIfFeature <em>If Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FeatureImpl extends ModuleStatementImpl implements Feature {
    /**
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YANGPackage.FEATURE__NAME, oldName, name));
	}
    ...
    public EList<IfFeature> getIfFeature() {
		if (ifFeature == null) {
			ifFeature = new EObjectContainmentEList<IfFeature>(IfFeature.class, this, YANGPackage.FEATURE__IF_FEATURE);
		}
		return ifFeature;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YANGPackage.FEATURE__IF_FEATURE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YANGPackage.FEATURE__NAME:
				return getName();
			case YANGPackage.FEATURE__IF_FEATURE:
				return getIfFeature();
		}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case YANGPackage.FEATURE__NAME: return YANGPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case YANGPackage.NAMED_ELEMENT__NAME: return YANGPackage.FEATURE__NAME;
				default: return -1;
			}
		}
