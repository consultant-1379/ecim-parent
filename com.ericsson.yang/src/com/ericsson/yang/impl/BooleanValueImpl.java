 ...
 * <ul>
 *   <li>{@link com.ericsson.yang.impl.BooleanValueImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanValueImpl extends ValueImpl implements BooleanValue {
    ...
    protected EClass eStaticClass() {
		return YANGPackage.Literals.BOOLEAN_VALUE;
	}
    ...
    public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YANGPackage.BOOLEAN_VALUE__VALUE, oldValue, value));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YANGPackage.BOOLEAN_VALUE__VALUE:
				return isValue();
		}
