 ...
 * <ul>
 *   <li>{@link com.ericsson.yang.impl.IntValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntValueImpl extends ValueImpl implements IntValue {
    ...
    protected EClass eStaticClass() {
		return YANGPackage.Literals.INT_VALUE;
	}
    ...
    public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YANGPackage.INT_VALUE__VALUE, oldValue, value));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YANGPackage.INT_VALUE__VALUE:
				return getValue();
		}
