 ...
 * <ul>
 *   <li>{@link com.ericsson.yang.impl.StringValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringValueImpl extends ValueImpl implements StringValue {
    ...
    protected EClass eStaticClass() {
		return YANGPackage.Literals.STRING_VALUE;
	}
    ...
    public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YANGPackage.STRING_VALUE__VALUE, oldValue, value));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YANGPackage.STRING_VALUE__VALUE:
				return getValue();
		}
