 ...
 * <ul>
 *   <li>{@link TspMim.impl.StatusTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatusTypeImpl extends EObjectImpl implements StatusType {
    ...
    protected EClass eStaticClass() {
		return TspMimPackage.Literals.STATUS_TYPE;
	}
    ...
    public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TspMimPackage.STATUS_TYPE__MIXED);
		}
		return mixed;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TspMimPackage.STATUS_TYPE__MIXED:
