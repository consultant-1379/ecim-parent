 ...
 * <ul>
 *   <li>{@link TspMim.impl.DependenciesTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesTypeImpl extends EObjectImpl implements DependenciesType {
    ...
    protected EClass eStaticClass() {
		return TspMimPackage.Literals.DEPENDENCIES_TYPE;
	}
    ...
    public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TspMimPackage.DEPENDENCIES_TYPE__MIXED);
		}
		return mixed;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TspMimPackage.DEPENDENCIES_TYPE__MIXED:
