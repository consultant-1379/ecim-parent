...
public class ImmSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ImmPackage.ATTR_DEF: {
                AttrDef attrDef = (AttrDef)theEObject;
                T result = caseAttrDef(attrDef);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.ATTR_TYPE: {
                AttrType attrType = (AttrType)theEObject;
                T result = caseAttrType(attrType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.CLASS_DEF: {
                ClassDef classDef = (ClassDef)theEObject;
                T result = caseClassDef(classDef);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.DOCUMENT_ROOT: {
                DocumentRoot documentRoot = (DocumentRoot)theEObject;
                T result = caseDocumentRoot(documentRoot);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.IMM_CONTENTS_TYPE: {
                IMMContentsType immContentsType = (IMMContentsType)theEObject;
                T result = caseIMMContentsType(immContentsType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.OBJECT_DEF: {
                ObjectDef objectDef = (ObjectDef)theEObject;
                T result = caseObjectDef(objectDef);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ImmPackage.RDN_DEF: {
                RdnDef rdnDef = (RdnDef)theEObject;
                T result = caseRdnDef(rdnDef);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>IMM Contents Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>IMM Contents Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseIMMContentsType(IMMContentsType object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Rdn Def</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Rdn Def</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseRdnDef(RdnDef object) {
        return null;
    }
